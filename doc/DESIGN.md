...
* **產品品牌/生廠商**：使用者在辨識或申報回收紀錄時所關聯的特定生廠商或品牌名稱（如 Coca-Cola、Sprite、原萃），協助管理端和社會各界追蹤綠色產品責任與塑料瓶/包裝回收統計。
* **品牌統計**：管理員後台的統計分頁，動態分析所有品牌之累計回收次數與關聯之回收歷史，支援詳細履歷查閱，以數據推動企業社會責任 (EPR)。
